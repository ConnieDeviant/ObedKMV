...
////////////////////////////////////////////
$gorod=cleanValue($_POST["gorod"]);
$adres=cleanValue($_POST["adres"]);
////////////////////////////////////
$dostavka="";
if($gorod=="Пятигорск")$dostavka="150р";
else if($gorod=="Ессентуки")$dostavka="500-550р";
else if($gorod=="Иноземцево")$dostavka="200-250р";
else if($gorod=="Железноводск")$dostavka="500-550р";
else if($gorod=="Лермонтов")$dostavka="300-350р";
else if($gorod=="Мин.Воды")$dostavka="500-550р";
else if($gorod=="Кисловодск")$dostavka="1000р"; 
else if($gorod=="Георгиевск")$dostavka="1000р";
...
Адрес: $adres<br>
  ...
  if (!empty($cart)) {
    ...
    $body .= "
      ...
      <tr style='height: 50px;'>
        <td colspan='3' style='text-align: right;'><b>Доставка:</b></td>
        <td style='width: 100px; text-align: right;'><b>$dostavka</b></td>
      </tr>
    </table>
    ";
  }
